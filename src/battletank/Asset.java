...
public class Asset {
    ...
    public static String path_board_bet = path_asset + "bgbet.png";
    ...
    public static String path_check = path_asset + "check.png";
    ...
    public static MyImage check = new MyImage(path_check);
            
   // bet background
            public static MyImage betBackground = new MyImage(path_board_bet);
